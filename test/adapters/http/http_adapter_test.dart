import 'package:parking_lot_app/data/http/http.dart';
import 'package:parking_lot_app/intra/http/http.dart';
...
void main() {
  ...
  group('post', () {
    ...
    test('Should return null if post returns 201 with data', () async {
      client.mockPost(201);
